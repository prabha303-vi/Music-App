package com.prabha.player.AppWidget;
...
import com.prabha.player.Services.QueueWidgetService;
import com.prabha.player.Utils.Constants;

/**
 * Created by Prabha Raj on 12/26/17.
 */
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < N; i++) {
             ...
             * index of the listview item that's been clicked. */
                ...
                intent.setAction("com.prabha.player.action.STOP");
