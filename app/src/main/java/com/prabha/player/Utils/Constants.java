...
/**
 * Created by Prabha Raj on 4/21/2018.
 */
...
public class Constants {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.prabha.player.action.PLAY_PAUSE";
    public static final String ACTION_STOP = "com.prabha.player.action.STOP";
    public static final String ACTION_NEXT = "com.prabha.player.action.NEXT";
    public static final String ACTION_PREVIOUS = "com.prabha.player.action.PREVIOUS";
    public static final String ACTION_PAUSE = "com.prabha.player.action.PAUSE";

    public static final String ACTION_UPDATE_NOW_PLAYING_UI = "com.prabha.player.action.UPDATE_NOW_PLAYING_UI";
